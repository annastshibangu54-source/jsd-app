...
$host     = "dpg-dao54i8473hc73bfmfng-a"; // Remplacez par votre Host Render interne/externe
$port     = "5432";
$dbname   = "jsd_db";           // Remplacez par le nom de votre DB Render
$user     = "jsd_user";         // Remplacez par votre User Render
$password = "fEPwCcF3c3XE6WYc8hOdXoBOQLXWUlfj"; // Remplacez par votre Password Render
